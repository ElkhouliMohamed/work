...
<div class="container mx-auto px-4 py-8 sm:px-6 lg:px-8 flex justify-center items-center min-h-screen bg-gray-50">
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
        ...
        <p class="text-sm text-gray-600 text-center mb-8">Sign in to your account to continue</p>
            ...
            <div>
                ...
                <div class="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input id="email" name="email" type="email" value="{{ old('email') }}" required autocomplete="email" autofocus
                        class="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-3 px-4 placeholder-gray-400"
        ...
        @if (Route::has('register'))
            <div class="mt-6 text-center text-sm">
                <p class="text-gray-500">Don't have an account? <a href="{{ route('register') }}" class="font-medium text-indigo-600 hover:text-indigo-500">Sign up</a></p>
            </div>
        @endif
    </div>
</div>
