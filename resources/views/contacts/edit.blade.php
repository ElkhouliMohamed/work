...
<div class="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
    <div class="text-center mb-10">
        <h1 class="text-3xl font-bold text-gray-900 sm:text-4xl">Modifier le Contact</h1>
        <p class="mt-3 text-lg text-gray-500">Mettez à jour les informations de {{ $contact->prenom }} {{ $contact->nom }}</p>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white shadow-xl rounded-2xl overflow-hidden">
        ...
        <form action="{{ route('contacts.update', $contact) }}" method="POST" class="p-6 sm:p-8 space-y-6">
            @csrf
            @method('PUT')
