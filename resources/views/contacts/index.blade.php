            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div
                                    ...
                                    <span class="text-indigo-600 font-medium">{{ strtoupper(substr($contact->nom, 0, 1))
                                        }}{{ strtoupper(substr($contact->prenom, 0, 1)) }}</span>
                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">{{ $contact->nom }} {{
                                        $contact->prenom }}</div>
                                    <div class="text-sm text-gray-500">{{ $contact->entreprise ?? 'Sans entreprise' }}
                                    </div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $contact->nom_entreprise }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
